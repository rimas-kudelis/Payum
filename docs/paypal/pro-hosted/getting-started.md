...
# PayPal Pro Hosted. Getting started.
...
Here you have to modify a `gatewayName` value. Set it to `paypal_pro_hosted`. The rest remain the same as described in basic [getting started](../../getting-started.md) documentation.
